...
def scrap_page(table,page)
  ...
  while n < 2
    ...
    name_list = [id_match,shots_on_goal_1,shots_off_goal_1,total_shots_1,blocked_shots_1,goalkeeper_saves_2,possession_1,cartons_jaunes_1,cartons_rouges_1,fouls_1,pass_1]
    ##ext_name_list = [id_match,shots_on_goal_2,shots_off_goal_2,total_shots_2,blocked_shots_2,goalkeeper_saves_1,possession_2,cartons_jaunes_2,cartons_rouges_2,fouls_2,pass_2]
...
def new_csv(table)
  ...
  print columns
  l = 0
  report = "Stats_matchs_equipe_domicile" #report = "journee_#{c}"
...
def perform()
  ...
  table = [array_id_match,array_shots_on_goal_1,array_shots_off_1,array_total_shots_1,array_blocked_shots_1,array_goalkeeper_saves_2,array_possession_1,array_cartons_jaunes_1,array_cartons_rouges_1, array_fouls_1, array_pass_1]
